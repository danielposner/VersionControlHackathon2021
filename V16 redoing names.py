...
#########################################
    ...
    def function_list(self):
        ...
        self.full_list = [self._mean, self._median, self._std, self._standard_error, self._inter_quartile_range,
                          self._listing_Confidence_Intervals, ## These are the killable tests
                          self._two_tailed_t_test, self._pearson_correlation_test,
                          self._spearman_correlation_test, self._dependency_regression_1,
                          self._liner_regression_model]
