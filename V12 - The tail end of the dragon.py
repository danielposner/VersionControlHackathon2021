...
class Main:
    ...
    def _two_tailed_t_test(self, a,b):
        """ Assumption of normality and equal variance """
        ### Later I will want to create tests for the other T-Tests
        return( scipy.stats.ttest_ind(a, b, axis=0, equal_var=True, nan_policy='propagate',
                              permutations=None, random_state=None, alternative='two-sided', trim=0))
    ...
    def function_list(self):
        ...
        self.full_list = [self._mean, self._median, _two_tailed_t_test]
        ...
        with open('HackathonOutput.csv', 'w', newline='') as file:
            ...
            for pair in allcols:
                ...
                for function in self.full_list:
                    results.append(function(wines[:,pair[0]], wines[:,pair[1]]))
                    #writer.writerow(items)
                results.append(self.tag) ## Adds tag to end -> Mess with joining at end during cleanup
